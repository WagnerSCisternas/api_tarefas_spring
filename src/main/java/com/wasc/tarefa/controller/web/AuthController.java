...
public class AuthController {
	...
	// A injeção de AuthenticationManager NÃO é mais necessária aqui, pois o Spring
	// Security lida com o formLogin()
	// @Autowired
	...
	public String showLoginForm(Model model, @RequestParam(value = "error", required = false) String error,
		...
		// Estas mensagens são passadas por Spring Security em caso de falha ou sucesso
		// de logout
		if (error != null) {
	...
	// O Spring Security agora lida com o POST para /login automaticamente via
	// formLogin().
	/*
	 ...
	 * // Este código não é mais necessário aqui, pois o Spring Security o gerencia
	 * internamente. // O defaultSuccessUrl() e failureUrl() do formLogin() já
	 * cuidarão do redirecionamento. }
	 */
